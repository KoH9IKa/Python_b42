...
def test_add_address_bot_but(app):
    ...
    app.address.fill_form_with_check(Contact(first_name="Валерий",
                                             mid_name="Непомню",
                                             last_name="Меладзе",
...
def test_add_address_top_but(app):
    ...
    app.address.add_new_address()
    # Месяц вводить цифрами от "1" до "12", День от "1" до "31", форма может принимать None
    app.address.fill_form_with_check(Contact(first_name="Константин",
                                             mid_name="Андреевич",
                                             last_name="Верченко",
                                             nick_name="Костян",
                                             title="QA Eng.",
    ...
    app.address.add_default_filled_address(1)
